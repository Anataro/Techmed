<?php
    ...
    if (isset($_POST['email']))
    {
      ...
      $sekret = "6Lftlp8UAAAAAA9HrT9igRhGkP5ARUHOLTjy3UcW";
...
<form method="post">
    ...
    value="<?php if(isset($_SESSION['fr_haslo']))
     {
    ...
    value="<?php if(isset($_SESSION['fr_haslo2']))
     {
    ...
    ?>
    <div class="g-recaptcha" data-sitekey="6Lftlp8UAAAAAPNy9YEUGGi0yZdk0NVVi3n14laX"></div>
    <br>
    <?php
